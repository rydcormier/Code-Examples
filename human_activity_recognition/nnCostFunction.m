...
%   nueral network cost function and returns the cost function value and
%	gradient.
%
...
for l = 1:( L - 1 )
    ...
    reg_term( :, 1 ) = zeros( size( reg_term, 1 ), 1 ); % ignore bias
